; ModuleID = './test/hello.ll'
source_filename = "hello.cpp"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx16.0.0"

@.str = private unnamed_addr constant [13 x i8] c"ZQ:~[vE[$~P\\\12", align 1
@.str.1 = private unnamed_addr constant [34 x i8] c"F\\?a\14%fF?|Sva\\9gX22V32[4tA%qU\22wP\\\12", align 1
...
define noundef i32 @main() #0 {
  ...
  %2 = call i32 (ptr, ...) @printf(ptr noundef %decoded_str)
  %decoded_str1 = call ptr @decode(ptr @.str.1)
  %3 = call i32 (ptr, ...) @printf(ptr noundef %decoded_str1)
  ret i32 0
}
